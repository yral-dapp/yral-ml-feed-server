...
# VIDEO_NSFW_TABLE = f"`{DATASET}.video_nsfw`" 
    ...
    # Stage table names
    VIDEO_EMBEDDINGS_TABLE = f"`{STAGE_PROJECT_ID}.{STAGE_DATASET}.stage_video_embeddings`"
    GLOBAL_POPULAR_VIDEOS_TABLE = f"`{STAGE_PROJECT_ID}.{STAGE_DATASET}.stage_global_popular_videos`"
